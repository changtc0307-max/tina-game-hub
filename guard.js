...
const musicExtra=document.createElement('script');musicExtra.src='music-extra.js?v=20260915-9';musicExtra.onload=()=>{const lyrics=document.createElement('script');lyrics.src='lyrics-game.js?v=20260916-10';lyrics.onload=()=>{const bank=document.createElement('script');bank.src='lyrics-bank-expanded.js?v=20260916-1';bank.onload=()=>{const bestards=document.createElement('script');bestards.src='lyrics-bestards-supplement.js?v=20260916-1';bestards.onload=()=>{const extra=document.createElement('script');extra.src='lyrics-extra.js?v=20260916-12';extra.onload=()=>{const ui=document.createElement('script');ui.src='lyrics-ui.js?v=20260915-9';document.head.appendChild(ui)};document.head.appendChild(extra)};document.head.appendChild(bestards)};document.head.appendChild(bank)};document.head.appendChild(lyrics)};document.head.appendChild(musicExtra);
